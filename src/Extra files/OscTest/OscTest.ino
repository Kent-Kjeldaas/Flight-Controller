...
void setup() {
  ...
  for (cal_int = 0; cal_int < 2000 ; cal_int ++) {             //Take 2000 readings for calibration.
    if (cal_int % 15 == 0)digitalWrite(A2, !digitalRead(A2));  //Change the led status to indicate calibration.
  ...
  PCMSK0 |= (1 << PCINT3);                                     //Set PCINT3 (digital input 11)to trigger an interrupt on state change.
   Serial.println("TURN ON RADIO CONTROLLER!!");
  ...
  // When everything is done, turn the LED on. 
  //digitalWrite(A3, HIGH); 
  //When everything is done, turn off the led.
  digitalWrite(A2, LOW);                                       //Turn off the warning led.
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Main program loop
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
