...
bool bluetooth = true; // Bluetooth or Radio Control?
bool first = true; //Is this the first time?
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Setup routine
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void setup(){
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void loop(){
  while (first && bluetooth) {
    if (bd.available()) {
      char val1 = bd.read();
      if (val1 == '1') { //add start sign
        bd.write("r");
        delay(3000);
        first = false;
        start = 1;
  ...
  if(!bluetooth){
    ...
    if (bd.available()) {
      ...
      if (c == '*') {
        ...
        yaw = readString.indexOf(ind2+1, ind3);
        ind4 = readString.indexOf(',', ind3+1 );
        thrust = readString.substring(ind3+1, ind4); 
        ind5 = readString.indexOf(',', ind4+1 );
        omega_S = readString.substring(ind4+1, ind5); 
        receiver_input_channel_2 = roll.toInt();
        receiver_input_channel_1 = pitch.toInt();
        receiver_input_channel_3 = thrust.toInt();
        receiver_input_channel_4 = yaw.toInt();
  ...
  throttle = receiver_input_channel_3+50;                                   //We need the throttle signal as a base signal.
  ...
  if (start == 2){                                                          //The motors are started.
    ...
    servo_1 = map(esc_1, 1000, 2000, 90, 140);
    servo_2 = map(esc_2, 1000, 2000, 90, 140);
    servo_3 = map(esc_3, 1000, 2000, 90, 140);
    servo_4 = map(esc_4, 1000, 2000, 90, 140); //what is the middle value 1500 throttle? (0 deg -> +7 deg, find the values)    
    ...
    if (esc_1 < 1250) esc_1 = 1250;                                         //Keep the motors running.
    if (esc_2 < 1250) esc_2 = 1250;                                         //Keep the motors running.
 if (esc_3 < 1250) esc_3 = 1250;                                         //Keep the motors running.
    if (esc_4 < 1250) esc_4 = 1250;                                         //Keep the motors running.
