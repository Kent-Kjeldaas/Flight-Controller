...
//Settings
float kp1 = 0.4;    //Set P-term to limit desired angular velocity
float kp2 = 0.2;    //Set P-term to limit difference between m1 and m2
...
void loop() {
  ...
  gyro.read();
  X_gVH = (int)(gyro.data.x);
  Y_gVH = (int)(gyro.data.y);
